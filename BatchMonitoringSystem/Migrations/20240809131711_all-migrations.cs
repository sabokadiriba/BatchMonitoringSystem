        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocalDestinationPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RemoteDestinationPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NumberOfUniqueBatches = table.Column<int>(type: "int", nullable: false),
                    NumberOfDuplicateBatches = table.Column<int>(type: "int", nullable: false),
                    TotalNumberOfBatches = table.Column<int>(type: "int", nullable: false),
                    BackupUser = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SqlUserName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SqlPassword = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ActualDataId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblActualData", x => x.ActualDataId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CretedUser = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Batches_Equipment_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BatchParameterId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BatchId = table.Column<int>(type: "int", nullable: false),
                    ParameterName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchParameters", x => x.BatchParameterId);
                    table.ForeignKey(
                        name: "FK_BatchParameters_Batches_BatchId",
                        column: x => x.BatchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatchParameters_BatchId",
